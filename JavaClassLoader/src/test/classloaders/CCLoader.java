...
/**
 * Our Custom ClassLoader to load the classes. Any class in the com.sample.aritra
...
public class CCLoader extends ClassLoader {
     ...
     *
     * @param name Fully Classified name of the class, for example, com.sample.aritra.Foo
     */
     ...
     * com.sample.aritra package, we will use this classloader or else delegate the
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("com.sample.aritra")) {
